...
public class Editor2015 extends JFrame implements ActionListener, KeyListener {
  ...
  public void actionPerformed(ActionEvent ae) {
    if (ae.getActionCommand().equals("New")) {
      int ask;
      if (textchange == true) {
        ask = JOptionPane.showConfirmDialog(
            this,
    ...
    try {
      if (ae.getActionCommand().equals("Open")) {
        ...
        if (textchange == true) {
          ask = JOptionPane.showConfirmDialog(
              this,
              "Text has been changed. \nDo you want to save it?", "Changes Save",
              JOptionPane.YES_NO_CANCEL_OPTION,
              JOptionPane.QUESTION_MESSAGE);
          if (ask == 0) {
            SaveButtonCoding();
        ...
        if (!filename.equals("")) {
          try {
            ...
            Process error = r.exec("C:\\Program Files\\Java\\jdk-24\\bin\\javac.exe  " + fname);
        ...
        String h1 = "This Editor has been created by Mr. Kavindra. \nProject was completed under the guidence of Prof. Manish Bhatia (HOD Java Deptt.)";
