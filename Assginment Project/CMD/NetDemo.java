	...
	protected void commandControl(KeyEvent ke) {
		...
		if (c == '\n') {
			...
			if (commandEnter.startsWith("urlinfo") || commandEnter.startsWith("urlinfo ")) {
				...
				ta.append("The fuile(s) started are:\n" + ta_Run + "\n");
				ta.append(currentPath + prompt);
				ta.setEditable(false);
			} /////////////////////// WHOIS ////////////////////
			...
			////////////////////////////////EDIT/////////////////////////////
				...
				os_version = System.getProperty("od.version");
				...
				ta.append("OS Registerd to: " + usr_Name + "\n");
				ta.append("OS Registerd to: " + usr_Home + "\n");
				ta.append(currentPath + prompt);
				ta.setEditable(false);
			...
			////////////////////////////// PROMPT ////////////////
				...
				ta.append(currentContent + prompt);
				ta.setEditable(false);
			...
			/////////////////// HELP ///////////////////////////
				...
				ta.append(" cd          | Change directory          | cd Progarms\n");
				ta.append(" copy        | copy files                | copy readme.txt newreadme\n");

				ta.append(" dir         | Shows directory           | dir\n");
				ta.append(" memcheck    | Checks Memory             | memcheck\n");
				ta.append(" prompt      | Change prompt sig         | prompt >>>\n");
				...
				ta.append(" whois       | Gives information of site | whois internic.netdotcom.com\n");
